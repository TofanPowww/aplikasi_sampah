...
class DetailPengambilanView extends StatefulWidget {
  const DetailPengambilanView({super.key});

  @override
  State<DetailPengambilanView> createState() => _DetailPengambilanViewState();
}

class _DetailPengambilanViewState extends State<DetailPengambilanView> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Detail Pengambilan", style: appFontTitlePage),
        centerTitle: true,
